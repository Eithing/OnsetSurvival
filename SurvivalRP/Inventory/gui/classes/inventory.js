class Inventory {
    constructor(selector) {
        ...
        this.mouseUpHandler = (evt) => {
            ...
            target = evt.target;
            if (target && target.id === 'player-inventory-stuff1' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
            if (target && target.id === 'player-inventory-stuff2' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
            if (target && target.id === 'player-inventory-stuff3' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
            if (target && target.id === 'player-inventory-stuff4' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
            if (target && target.id === 'player-inventory-container' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
            if (target && target.id === 'player-inventory-slot1' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
            if (target && target.id === 'player-inventory-slot2' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
            if (target && target.id === 'player-inventory-slot3' && this.dragging !== null && previousContainer.id != target.id) {
                this.dropIntoTarget = target;
            }
        }
